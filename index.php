...
<body>
  <nav>
    ...
    <div class="d-flex justify-content-between align-items-center container-md p-2">
      ...
      <ul class="d-md-flex d-none list-unstyled gap-4">
        ...
        <li><a class="text-dark text-decoration-none" href="shop.php">Shop</a></li>
        <li><a class="text-dark text-decoration-none" href="testimonials.php">Testimonials</a></li>
        <li><a class="text-dark text-decoration-none" href="reviews.php">Reviews</a></li>
      </ul>
  ...
  <section class="banner min-vh-100" data-aos="fade-up">
    <img src="./assets/banner.jpg" alt="Banner" width="100%" class="vh-100">
    <div class="banner-center">
      <h1 class="text-white fw-bold text-nowrap">Dental Solutions</h1>
      <p class="text-white">Your Trusted Source for Dental Products</p>
      <a href="shop.php" class="btn btn-light mt-2 px-4 rounded-pill">SHOP NOW</a>
    </div>
  </section>
  <section class="shop-now p-sm-5 p-3">
    <p class="text-center mb-1 text-secondary">SHOP NOW</p>
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-sm-6 py-0 px-sm-3 px-0 d-flex flex-column justify-content-between gap-3">
          <div class="bg-light-pink" data-aos="fade-up">
            ...
            <h6 class="p-3">Oral Care Esentials</h6>
          </div>
          <div class="bg-light-pink" data-aos="fade-up">
